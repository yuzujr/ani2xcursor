...
public:
    ...
    static void write_cursor(const std::vector<CursorImage>& images,
                             const std::vector<uint32_t>& delays_ms, const fs::path& output_path);
    ...
    static void write_index_theme(const fs::path& theme_dir, const std::string& theme_name);
    ...
    static void create_aliases(const fs::path& cursors_dir, const std::string& primary_name,
